const textConvert = (type, text) => {
    const conversionMap = {a: 'а', b: 'б', v: 'в', g: 'г', d: 'д', gj: 'ѓ', e: 'е', zh: 'ж', z: 'з', dz: 'ѕ', i: 'и', j: 'j', k: 'к', l: 'л', lj: 'љ', m: 'м', n: 'н', nj: 'њ', o: 'о', p: 'п', r: 'р', s: 'с', t: 'т', kj: 'ќ', u: 'у',f: 'ф', h: 'х', c: 'ц', ch: 'ч', dzh: 'џ', sh: 'ш'};

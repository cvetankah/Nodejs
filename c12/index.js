...
//     .then(() => {
//     return Studenti.find({}); // vo find({}) treba da go definiram toa   sto sakam da mi bide vrateno. Toa nesto e Promise, sto znaci deka treba da se stavi .then/res/catch i eden console.log() za da mozam da gi citam podatocite
// })
//     .then(res => {
//         console.log(res);
//         let s = new Studenti({
